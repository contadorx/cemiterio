...
-- 2 do mes: o vencimento e `competencia + (dia_vencimento - 1)`, e nem todo
-- dia do mes tem "tres dias depois do vencimento" dentro do mesmo mes.
--
--   competencia    2026-03-01
--   dia_vencimento 10          -> vence em 2026-03-10
...
values
 ('aaaaaaaa-0000-0000-0000-000000000018','ff000000-0000-0000-0000-000000000181','debito','competencia','2026-03-01', 30,'contrato','2026-03-01'),
 ('aaaaaaaa-0000-0000-0000-000000000018','ff000000-0000-0000-0000-000000000182','debito','competencia','2026-03-01', 30,'contrato','2026-03-01'),
 ('aaaaaaaa-0000-0000-0000-000000000018','ff000000-0000-0000-0000-000000000183','debito','competencia','2026-03-01', 30,'contrato','2026-03-01')
on conflict do nothing;
...
values ('aaaaaaaa-0000-0000-0000-000000000018','ff000000-0000-0000-0000-000000000184',
        'debito','competencia','2026-03-01', 30,'contrato','2026-03-01')
on conflict do nothing;
...
insert into conta_corrente (org_id, familia_id, tipo, origem, competencia, valor, descricao, data)
values ('aaaaaaaa-0000-0000-0000-000000000018','ff000000-0000-0000-0000-000000000184',
        'debito','competencia','2026-04-01', 30,'outro mes','2026-04-01')
on conflict do nothing;
...
insert into conta_corrente (org_id, familia_id, tipo, origem, competencia, valor, descricao, data)
values ('aaaaaaaa-0000-0000-0000-000000000018','ff000000-0000-0000-0000-000000000184',
        'debito','competencia','2026-05-01', 30,'terceiro mes','2026-05-01')
on conflict do nothing;
