...
const s: Record<string, React.CSSProperties> = {
  ...
  dica: { color: "#64748b", fontSize: 14, margin: "0 0 14px" },
  opcao: { width: "100%", padding: 14, background: "#fff", color: "#0f172a", border: "1px solid #e2e8f0", borderRadius: 12, fontSize: 16, textAlign: "left", cursor: "pointer", marginBottom: 8 },
  opcaoMarcada: { background: "#fffbeb", borderColor: "#fde68a", fontWeight: 600 },
  input: { width: "100%", padding: 12, fontSize: 16, borderRadius: 10, border: "1px solid #e2e8f0", boxSizing: "border-box", minHeight: 70, fontFamily: "inherit", marginBottom: 10 },
  botao: { width: "100%", padding: 16, background: "#0f766e", color: "#fff", border: "none", borderRadius: 12, fontSize: 16, fontWeight: 700, cursor: "pointer", marginTop: 6 },
};
