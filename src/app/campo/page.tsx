...
const s: Record<string, React.CSSProperties> = {
  ...
  sair: { minHeight: 48, background: "none", border: "2px solid #e7e0cf", color: "#475569", borderRadius: 8, padding: "6px 12px", fontSize: 17, cursor: "pointer" },
  botaoMaterial: { width: "100%", minHeight: 60, padding: 18, background: "#fff", color: "#0f172a", border: "1px solid #e2e8f0", borderRadius: 12, fontSize: 17, fontWeight: 600, cursor: "pointer", marginBottom: 16 },
  faixaOffline: { background: "#fef3c7", border: "1px solid #fde68a", color: "#92400e", borderRadius: 10, padding: "10px 12px", fontSize: 18, marginBottom: 12, textAlign: "center" },
  topo: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 },
  data: { fontSize: 18, color: "#475569" },
  ...
  info: { textAlign: "center", color: "#475569", padding: 24 },
  quadra: { fontSize: 17, color: "#475569", margin: "16px 0 8px", textTransform: "uppercase", letterSpacing: 1 },
  ...
  pendente: { fontSize: 17, color: "#0f766e", fontWeight: 600 },
  check: { fontSize: 17, color: "#059669", fontWeight: 700 },
  falecido: { fontSize: 17, color: "#475569", marginTop: 4 },
