...
const st: Record<string, React.CSSProperties> = {
  ...
  fotoBtn: { width: "100%", padding: 15, background: "#fff", color: "#12284b", border: "2px dashed #cbd5e1", borderRadius: 12, fontSize: 15, cursor: "pointer" },
  ...
  gpsDica: { color: "#64748b", fontSize: 13, margin: "4px 0 0" },
  gpsMsg: { color: "#0f766e", fontSize: 14, fontWeight: 600, margin: "6px 0 0" },
  mapa: { color: "#12284b", fontSize: 13, textDecoration: "underline" },
  concluir: { width: "100%", padding: 16, background: "#0f766e", color: "#fff", border: "none", borderRadius: 12, fontSize: 17, fontWeight: 700, cursor: "pointer", marginTop: 6 },
  ...
  rotulo: { fontSize: 15, fontWeight: 600, color: NAVY, display: "block", marginBottom: 6 },
  dica: { color: "#64748b", fontSize: 13, margin: "4px 0 0" },
  erro: { color: "#dc2626", fontSize: 14, fontWeight: 600, margin: "8px 0" },
  botaoFoto: { width: "100%", padding: 15, background: "#fff", color: NAVY, border: "2px dashed #cbd5e1", borderRadius: 12, fontSize: 15, cursor: "pointer" },
  botaoFotoOk: { borderColor: TEAL, color: TEAL, background: "#f0fdfa", borderStyle: "solid" },
  botao: { width: "100%", padding: 16, background: TEAL, color: "#fff", border: "none", borderRadius: 12, fontSize: 17, fontWeight: 700, cursor: "pointer", marginTop: 6 },
