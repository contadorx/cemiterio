 ...
 *
 * O botão abre o WhatsApp com o texto pronto (wa.me), e só então marca como
 * enviado. Assim a mensagem sai da conta dela, com a cara dela — não de um
 * sistema.
 */
...
export default function Fila() {
  ...
  async function decidir(item: Item, acao: "enviar" | "descartar") {
    ...
    try {
      ...
      // Abre o WhatsApp com o texto pronto. A mensagem sai da conta dela.
      if (acao === "enviar" && item.telefone) {
      ...
      {itens.map((item) => (
        <div key={item.id} style={s.card}>
          ...
          <div style={s.acoes}>
            ...
            >
              {ocupado === item.id ? "..." : "Enviar pelo WhatsApp"}
            </button>
            <button
